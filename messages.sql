...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 05 mars 2020 à 09:30
...
CREATE TABLE IF NOT EXISTS `messages` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=62 DEFAULT CHARSET=utf8 COMMENT='La table qui va contenir tous les messages voyons !';
...
(61, 'Eric', 'Hello,', '2020-03-03 15:52:43');
COMMIT;
